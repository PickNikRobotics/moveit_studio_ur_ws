...
#include <moveit_pro_ml/onnx_clipseg.hpp>
 ...
 */
class ClipSegSegmentation : public moveit_studio::behaviors::AsyncBehaviorBase
{
public:
/**
   * @brief Constructor for the clipseg_segmentation behavior.
   ...
   */
 ClipSegSegmentation(const std::string& name, const BT::NodeConfiguration& config,
...
private:
 ...
 std::shared_ptr<moveit_pro_ml::ClipSeg> clipseg_;
